...
card: true
type: unit
name: Smart Citizen Kit 2.1 3D printed frog box
page_type: enclosure
version: SCK2.1
field:
  - air
...
This enclosure is to be used with the SCK 2.1. It's based on the [Frog Box design](https://www.thingiverse.com/thing:4582978), with additional modifications, remade from scratch in [Blender]([url](https://www.blender.org/)).
...
- 1x [clip](components/clip-sck2.1-PMS5003.stl)
