# Air Quality enclosures

These are examples of some outdoor cases for the different versions of the SCK with other sensors. You will find full 3D printed solutions, or some more complex solutions to be milled in a CNC on plastic.
...
!!! warning "No enclosure is perfect"
