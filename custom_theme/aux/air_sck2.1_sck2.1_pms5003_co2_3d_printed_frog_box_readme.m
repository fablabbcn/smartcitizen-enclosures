<div class="sensor-banner orange-sensor-banner">
    <a href="/Air/SCK2.1/SCK2.1_PMS5003_CO2/3D Printed frog box/" class="a-sensor-banner">
        <div class="sensor-image-block">
            <img src="/assets/images/2.2/SCKit_22_CO2.png" alt="Smart Citizen Kit 2.1 with carbon dioxide sensor" class="sensor-image">
        </div>
        <div class="sensor-tags-block-container">
            <h1>Smart Citizen Kit 2.1 with carbon dioxide sensor</h1>
