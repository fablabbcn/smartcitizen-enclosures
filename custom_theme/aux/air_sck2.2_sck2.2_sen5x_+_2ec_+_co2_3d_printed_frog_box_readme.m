<div class="sensor-banner orange-sensor-banner">
    <a href="/Air/SCK2.2/SCK2.2_SEN5X + 2EC + CO2/3D printed frog box/" class="a-sensor-banner">
        <div class="sensor-image-block">
            <img src="/assets/images/2.2/SCKit_22_CO2+2EC.png" alt="Smart Citizen Kit 2.2 with Carbon dioxide and 2 Electrochemical Sensors" class="sensor-image">
        </div>
        <div class="sensor-tags-block-container">
            <h1>Smart Citizen Kit 2.2 with Carbon dioxide and 2 Electrochemical Sensors</h1>
