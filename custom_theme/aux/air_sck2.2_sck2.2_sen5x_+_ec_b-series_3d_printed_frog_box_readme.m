<div class="sensor-banner orange-sensor-banner">
    <a href="/Air/SCK2.2/SCK2.2_SEN5X + EC B-Series/3D printed frog box/" class="a-sensor-banner">
        <div class="sensor-image-block">
            <img src="/assets/images/2.2/SCKit_EC_B-Series.jpg" alt="Smart Citizen Kit 2.2 EC B-Series" class="sensor-image">
        </div>
        <div class="sensor-tags-block-container">
            <h1>Smart Citizen Kit 2.2 EC B-Series</h1>
